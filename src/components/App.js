...
function App() {
  return (
    <div className="roote">
      <header class="header__cards--container">
        <img
          class="header__cards--img"
          src="./assets/images/logo-awesome-profile-cards.svg"
          alt="logo-awesome-profile-cards"
        />
      </header>

      <main class="wholeMain">
      ...
      <a className = "preview__icons--measures js_designColor js_previewPhone" href="#" target="_blank" title="phone"><i
      className = "fas fa-mobile-alt"></i></a>
      <a className = "preview__icons--measures js_designColor js_previewEmail" href="#" target="_blank" title="message"><i
      className = "far fa-envelope"></i></a>
      <a className = "preview__icons--measures js_designColor js_previewLinkedin" href="#" target="_blank" title="linkedin"><i
      className = "fab fa-linkedin-in"></i></a>
      <a className = "preview__icons--measures js_designColor js_previewGithub" href="#" target="_blank" title="github"><i
      ...
      <section className = "fill js_section js_fillSectionName hidden" id="fill">
      <fieldset className = "fill__first">
      <div className = "fill__first--name">
      <label for="fullName" className = "fill__first--name-lab">Nombre completo *</label>
      <input className = "fill__first--name-inp js_allInputs" placeholder="Ej: Sally Jill" id="name" type ="text"
      name="name" />
      </div>
      <div className = "fill__first--position">
      <label for="position" className = "fill__first--position-lab">Puesto *</label>
      <input className = "fill__first--position-inp js_allInputs" placeholder="Ej: Front-end unicorn" id="job" type ="text"
      name="job" />
      </div>
      </fieldset>
      ...
      <label className = "fill__second-button" for="photo">Añadir imagen</label>
      <input type ="file" id="photo" className = "hidden_button js__profile-upload-btn" value="Añadir imagen" />
      ...
      <label for="email" className = "fill__third--mail-lab">Email *</label>
      ...
      <label for="linkedinName" className = "fill__third--linked-lab">Linkedin *</label>
      ...
      <button className = "share__collapsable__button js_twiterBtn hidden">
      </button>
